/**
 * Produce a deterministic JSON representation suitable for reviewed-record
 * locks. Object keys are sorted recursively; array order remains significant.
 *
 * This intentionally follows JSON.stringify for JSON values. Unsupported
 * object properties are omitted, unsupported array entries become null, and
 * cyclic values and bigint values are rejected.
 */
...
export function recordContentSha256(value: unknown): string {
  return sha256Hex(canonicalRecordJson(value));
}
