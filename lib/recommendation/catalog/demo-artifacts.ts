...
export const demoArtifacts: Artifact[] = [
  artifact("qwen3-06b-q8", "Qwen3", "Qwen3 0.6B", "Q8_0", 0.8, 0.08, 32, 98, 0.76, [42, 48, 44, 62]),
  artifact("llama32-1b-q8", "Llama 3.2", "Llama 3.2 1B", "Q8_0", 1.3, 0.1, 16, 88, 0.82, [45, 54, 52, 61]),
  artifact("qwen3-17b-q8", "Qwen3", "Qwen3 1.7B", "Q8_0", 1.9, 0.14, 32, 76, 0.79, [58, 59, 55, 70]),
