...
above; their excluded future capabilities remain separately gated. U16 and U18
...
validation. U25 is resolved for the approved Windows-first, user-supplied-engine
route; M-O still must bind the receipt and candidate in one use-case result.
